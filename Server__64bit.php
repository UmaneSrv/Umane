...
class Server{
   ...
   /**
	 * @return string
	 */
	public function getSernyuBuild(){
		return \pocketmine\BUILD_VERSION;
	}
	...
	public function updatePlayerListData(UUID $uuid, $entityId, $name, $skinName, $skinData, array $players = \null){
		$pk = new PlayerListPacket();
