...
class Level implements ChunkManager, Metadatable{
	...
	public function getChunkPlayers($chunkX, $chunkZ){
		return isset($this->playerLoaders[$index = ($chunkX) . ":" . ( $chunkZ)]) ? $this->playerLoaders[$index] : [];
	}
	...
	public function getChunkLoaders($chunkX, $chunkZ){
		return isset($this->chunkLoaders[$index = ($chunkX) . ":" . ( $chunkZ)]) ? $this->chunkLoaders[$index] : [];
	}
	...
	*/
	...
	public function getBlock(Vector3 $pos, $cached = \true){
		...
		}elseif($pos->y >= 0 and $pos->y < 128 and isset($this->chunks[$chunkIndex = ($pos->x >> 4) . ":" . ( $pos->z >> 4)])){
