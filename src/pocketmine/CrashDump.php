...
class CrashDump{
	...
	private function generalData(){
		...
		$this->addLine("Sernyu version: " . $version->get(\false) . " #" . $version->getBuild() . " #" . Server::getInstance()->getSernyuBuild() . " [Protocol " . Info::CURRENT_PROTOCOL . " and up; API " . API_VERSION . "]");
