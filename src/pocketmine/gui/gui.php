...
class frmMain extends \wxFrame {
	...
	function onMenuHelpAbout() {
		$dlg = new \wxMessageDialog($this, "Sernyu is a third-party sofware for creating Minecraft: PE servers.\nIt has a Plugin API that enables a developer to extend it and add new features, or change default ones.\n\nThe entire server is done in PHP, and has been tested, profiled and optimized to run smoothly.", "About Sernyu...", wxICON_INFORMATION);
		$dlg->ShowModal();
	}

	function __construct($parent = \Null) {
		parent::__construct($parent, wxID_ANY, "Sernyu {VERSION} server", wxDefaultPosition, new \wxSize( 800,480 ), wxCAPTION|wxCLOSE_BOX|wxMINIMIZE_BOX|wxSYSTEM_MENU|wxTAB_TRAVERSAL );
		...
		$sbar->SetStatusText("Welcome to Sernyu.");
